...
values 
    (1,1,2,4,'Multiple Choice Example 1: |1|2|3|4|','mc','B',null,2,1,False),
    (2,1,2,4,'Numeric Input Example 1:','numeric','4',null,1,2,False),
    (3,1,2,4,'Whiteboard Input Example 1','whiteboard',null,null,4,1,True),
    (4,1,1,2,'Multiple Choice Example 2: |1|2|3|4|','mc','C',null,5,1,False),
    (5,1,1,2,'Numeric Input Example 2:','numeric','3',null,2,3,False),
    (6,1,1,1,'Whiteboard Input Example 2','whiteboard',null,null,5,1,True),
    (7,1,1,1,'Multiple Choice Example 3: |1|2|3|4|','mc','D',null,3,1,False),
    (8,1,2,3,'Numeric Input Example 3:','numeric','4',null,6,1,False),
    (9,1,1,2,'Whiteboard Input Example 3','whiteboard',null,null,1,1,True),
    (10,1,2,4,'Multiple Choice Example 4: |1|2|3|4|','mc','D',null,8,3,False),
    (11,1,1,2,'Numeric Input Example 4:','numeric','1',null,6,1,False),
    (12,1,2,3,'Whiteboard Input Example 4','whiteboard',null,null,5,1,True),
    (13,1,2,4,'Multiple Choice Example 5: |1|2|3|4|','mc','B',null,1,2,False),
    (14,1,1,2,'Numeric Input Example 5:','numeric','3',null,4,2,False),
    (15,1,2,3,'Whiteboard Input Example 5','whiteboard',null,null,1,3,True),
    (16,1,2,3,'Multiple Choice Example 6: |1|2|3|4|','mc','B',null,4,1,False),
    (17,1,2,4,'Numeric Input Example 6:','numeric','3',null,4,3,False),
    (18,1,1,2,'Whiteboard Input Example 6','whiteboard',null,null,6,3,True),
    (19,1,2,3,'Multiple Choice Example 7: |1|2|3|4|','mc','D',null,8,2,False),
    (20,1,1,1,'Numeric Input Example 7:','numeric','3',null,8,3,False),
    (21,1,2,4,'Whiteboard Input Example 7','whiteboard',null,null,7,2,True),
    (22,1,1,2,'Multiple Choice Example 8: |1|2|3|4|','mc','C',null,10,2,False),
    (23,1,1,1,'Numeric Input Example 8:','numeric','1',null,5,2,False),
    (24,1,1,1,'Whiteboard Input Example 8','whiteboard',null,null,6,1,True),
    (25,1,2,3,'Multiple Choice Example 9: |1|2|3|4|','mc','C',null,10,2,False),
    (26,1,2,4,'Numeric Input Example 9:','numeric','3',null,9,2,False),
    (27,1,2,4,'Whiteboard Input Example 9','whiteboard',null,null,10,3,True),
    (28,1,1,2,'Multiple Choice Example 10: |1|2|3|4|','mc','B',null,5,2,False),
    (29,1,1,1,'Numeric Input Example 10:','numeric','1',null,4,1,False),
    (30,1,2,3,'Whiteboard Input Example 10','whiteboard',null,null,5,2,True),
    (31,1,1,2,'Multiple Choice Example 11: |1|2|3|4|','mc','D',null,5,3,False),
    (32,1,1,1,'Numeric Input Example 11:','numeric','4',null,4,1,False),
    (33,1,1,2,'Whiteboard Input Example 11','whiteboard',null,null,2,2,True),
    (34,1,2,4,'Multiple Choice Example 12: |1|2|3|4|','mc','D',null,5,3,False),
    (35,1,1,2,'Numeric Input Example 12:','numeric','1',null,7,1,False),
    (36,1,2,3,'Whiteboard Input Example 12','whiteboard',null,null,4,3,True),
    (37,1,2,3,'Multiple Choice Example 13: |1|2|3|4|','mc','B',null,5,3,False),
    (38,1,2,4,'Numeric Input Example 13:','numeric','2',null,5,1,False),
    (39,1,2,3,'Whiteboard Input Example 13','whiteboard',null,null,5,2,True),
    (40,1,2,3,'Multiple Choice Example 14: |1|2|3|4|','mc','C',null,3,1,False),
    (41,1,1,2,'Numeric Input Example 14:','numeric','1',null,4,2,False),
    (42,1,1,2,'Whiteboard Input Example 14','whiteboard',null,null,1,1,True),
    (43,1,2,3,'Multiple Choice Example 15: |1|2|3|4|','mc','C',null,6,2,False),
    (44,1,1,2,'Numeric Input Example 15:','numeric','2',null,2,3,False),
    (45,1,1,1,'Whiteboard Input Example 15','whiteboard',null,null,7,1,True),
    (46,1,2,4,'Multiple Choice Example 16: |1|2|3|4|','mc','A',null,5,3,False),
    (47,1,1,1,'Numeric Input Example 16:','numeric','4',null,4,3,False),
    (48,1,1,1,'Whiteboard Input Example 16','whiteboard',null,null,1,1,True),
    (49,1,1,2,'Multiple Choice Example 17: |1|2|3|4|','mc','C',null,3,2,False),
    (50,1,1,1,'Numeric Input Example 17:','numeric','1',null,1,1,False);
