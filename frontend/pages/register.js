...
import { Button, Heading, HStack, Input, InputGroup, InputLeftElement, Link, Radio, RadioGroup, VStack, Icon, Center, Tooltip } from "@chakra-ui/react";
...
export default function Register() {
  ...
  return (
    <VStack w="100vw" h="100vh" justify="center" spacing="6">
      ...
      <Center>
        <Tooltip hasArrow label="Please enter a name" bg="red" isOpen={nameTooltipOpen} placement="top">
          <InputGroup>
            <InputLeftElement children={<Icon as={FaUser} color="gray.400" />} />
            <Input name="name" placeholder="Name" w="400px" m="4" onChange={handleChange} isInvalid={invalidName} m="0" />
          </InputGroup>
        </Tooltip>
      </Center>
      <Center>
      ...
      <Center>
        <Tooltip hasArrow label={password.length < 8 ? "Password must be at least 8 characters" : "Passwords don't match"} bg="red" isOpen={pwTooltipOpen} placement="top">
          <InputGroup>
      ...
      <Center>
        <InputGroup>
          <InputLeftElement children={<Icon as={GiConfirmed} color="gray.400" />} />
          <Input name="passCon" type="password" placeholder="Confirm Password" w="400px" m="4" onChange={handleChange} isInvalid={invalidPass} m="0"/>
        </InputGroup>
      </Center>
      ...
      <HStack>
        ...
        <Button colorScheme="teal" onClick={handleClick}>Register</Button>
      </HStack>
    </VStack>
  );
}
