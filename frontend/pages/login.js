  ...
  return (
    <VStack w="100vw" h="100vh" justify="center" spacing="6">
      ...
      <Center>
        <Tooltip
          hasArrow
          label={invalidCreds ? "Invalid credentials" : "Please enter an email"}
          bg="red"
          isOpen={emailTooltipOpen || invalidCreds}
          placement="top"
        >
          <InputGroup>
            <InputLeftElement
            ...
            <Input
              ...
              isInvalid={invalidEmail || invalidCreds}
              m="0"
            />
          </InputGroup>
        </Tooltip>
        ...
        >
          <InputGroup>
            ...
            <Input
              ...
              m="4"
              onChange={handleChange}
              isInvalid={invalidPass || invalidCreds}
              m="0"
            />
          </InputGroup>
        </Tooltip>
